...
export const environment = {
    ...
    supabase: {
        url: 'https://gowreoaeuipmpwmdbqtf.supabase.co',
        anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imdvd3Jlb2FldWlwbXB3bWRicXRmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mzk4NjgwMTEsImV4cCI6MjA1NTQ0NDAxMX0.GfVGqjn4rhJqID3PL46zI1YPN1QEmC1Z7BvG34sj3So'
      },
    production: false,
    apiKey: "AIzaSyBo7-gJUXqt25TEz7G-Gn6Ctdf7YsG54RY",
    serverUrl: "https://payment-server-wheat.vercel.app/",
    recaptcha: {
      siteKey: '6LcMZR0UAAAAALgPMcgHwga7gY5p8QMg1Hj-bmUv'  // your site key
    },
    CountryJson: [
      {
          "name": "Afghanistan",
      ...
      },
      {
          ...
          "dialCode": "+963",
          "isoCode": "SY",
          "flag": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Flag_of_the_Syrian_revolution.svg/800px-Flag_of_the_Syrian_revolution.svg"
      },
      {
          "name": "Taiwan",
          "dialCode": "+886",
